...
Un gráfico de barras apiladas no es lo mismo que un gráfico de barras estándar. Mientras que un gráfico de barras tradicional muestra una sola variable categórica en forma de barras, un gráfico de barras apiladas muestra dos variables categóricas. La primera variable se representa a lo largo de toda la longitud de la barra, y la segunda como secciones apiladas dentro de cada barra.
...
````
---
Este documento se basó en el artículo original [What is a stacked bar chart?](https://www.storytellingwithdata.com/blog/stacked-bars) de Storytelling with Data, traducido y adaptado por Daniela Serrano Campos.
